...
public class StringSerialization {
    ...
    public static void main(String[] args) {
        String[] s = {"abcd", "efgh"};
        Stream<String> str1 = Stream.of(s);
        str1.forEach(f -> System.out.println(f));
        byte[] bs = serializeStrings(s);
        System.out.println("serializeStrings=" + new String(bs));
        String[] t = deserializeStrings(bs);
        Stream<String> str2 = Stream.of(t);
        str2.forEach(f -> System.out.println(f));
    }

    /**
     * Serializes an array of strings into bytes.
     *
     * @param strings array of strings to be deserialized
