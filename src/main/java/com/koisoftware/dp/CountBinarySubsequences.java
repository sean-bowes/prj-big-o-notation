...
public class CountBinarySubsequences {
     ...
     * N], H[Q+1 ... M])
     *
     * @param haystack string containing 0s and 1s to be searched for subsequences
     * @param needle   subsequence containing 0s and 1s to be searched
