...
public class QuickSortByComparatorTest {
    ...
    public void ascendingOrderSort() {
        ...
        Integer[] sorted = QuickSortByComparator.quickSort(array, ascOrderComparator);
    ...
    public void descendingOrderSort() {
        ...
        Integer[] sorted = QuickSortByComparator.quickSort(array, descOrderComparator);
        assertArrayEquals("Failure => Array returned is not sorted.", sorted,
    ...
    public void onlyPivotsInArray() {
        ...
        int pivotIndex = QuickSortByComparator.partition(array, 0, array.length - 1,
