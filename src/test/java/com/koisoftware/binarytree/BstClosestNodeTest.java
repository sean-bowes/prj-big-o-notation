package com.koisoftware.binarytree;

import com.koisoftware.binarytrees.BstClosestNode;
import com.koisoftware.binarytrees.TreeNode;
...
public class BstClosestNodeTest {
    ...
    public void treeWithNoInorderPredecessorAndSubtreeInorderSuccessor() {
        ...
        TreeNode<Integer> answer = BstClosestNode.findClosestNode(
                root, rootLeft);
